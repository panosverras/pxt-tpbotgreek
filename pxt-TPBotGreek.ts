...
namespace TPBot {
    ...
    */
    export enum LineState {
        //% block="Μαύρο" enumval=0
        Black,
        //% block="Λευκό"enumval=1
        White
    }
    /**
    * Line Sensor Side
    */
    export enum LineSide {
        //% block="Αριστερά" enumval=0
        Left,
        //% block="Δεξιά" enumval=1
        Right
    }
    /**
     * Line Sensor events  
    ...
    */
     ...
     */
    //% weight=99
    //% block="Ορισε ταχύτητα δεξιού τροχού σε %lspeed\\%| ταχύτητα αριστερού τροχού σε %rspeed\\%"
    ...
    */
    //% weight=95
    //% block="Προχώρησε %direc με ταχύτητα %speed\\% για %time δευτερόλεπτα"
    ...
    */
    //% weight=90
    //% block="Προχώρησε %direc με ταχύτητα %speed\\%"
    //% speed.min=0 speed.max=100
    //% direc.fieldEditor="gridpicker" direc.fieldOptions.columns=2
    ...
    */
    //% weight=80
    //% block="Σταμάτησε το όχημα αμέσως"
    ...
    */
    //% weight=60
    //% block="Η κατάσταση του αισθητήρα γραμμής είναι %state"
    ...
    */
    //% weight=50
    //% block="On %side| αισθητήρας γραμμής εντόπισε %state"
    //% side.fieldEditor="gridpicker" side.fieldOptions.columns=2
    //% state.fieldEditor="gridpicker" state.fieldOptions.columns=2
    ...
    */
    //% weight=40
    //% block="Μονάδα μέτρησης αισθτήρα υπερήχων %unit"
    ...
    */
    //% block="Ορισε χρώμα προβολέα σε $color"
    //% weight=30
    ...
    */
    ...
    //% block="Ορισε χρώμα προβολέα σε R:%r G:%g B:%b"
    //% r.min=0 r.max=255
    //% g.min=0 g.max=255
    //% b.min=0 b.max=255
    ...
    */
    ...
    /*
    //% weight=15
    //% block="Ορισε την γωνία του 180° σερβοκινητήρα %servo σε %angle °"
    ...
    */
    //% weight=14
    //% block="Ορισε την ταχύτητα του 360° σερβοκινητήρα %servo σε %speed \\%"
    //% servo.fieldEditor="gridpicker"
    //% servo.fieldOptions.columns=1
     ...
     */
    //% weight=15
    //% block="Ορισε την γωνία του %ServoTypeList σερβοκινητήρα %servo σε %angle °"
